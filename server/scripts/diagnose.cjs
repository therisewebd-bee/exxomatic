...
ws.on('open', () => {
  ...
  setTimeout(() => {
    ...
    client.connect(TCP_PORT, TCP_HOST, () => {
      ...
      const packet = `$1,AEPL,0.0.1,NR,2,H,${TEST_IMEI},XXXXXXXXXX,1,${d},${t},18.520400,N,73.856700,E,45.20,180.00,10,553.00,1.27,1.00,AIRTEL,1,1,23.20,4.20,0,O,28,404,90,110E,E0EB,,0000,00,000074,9822,*\n`;
