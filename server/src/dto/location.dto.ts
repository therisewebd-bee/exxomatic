...
const latSchema = z.coerce.number().min(-90, "Latitude must be between -90 and 90").
    max(90, "Latitude must be between -90 and 90")


const lngSchema = z.coerce.number().min(-180, "Longitude must be between -180 and 180").
